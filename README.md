...
A fun, interactive memory card matching game built with React. Perfect for
learning how to work with AI coding agents through GitHub issues!
...
This game is designed for workshops where participants use AI coding agents
(like Coder, Cursor, or GitHub Copilot) to implement features via GitHub issues.
...
Below are ready-to-use GitHub issues categorized by difficulty. Copy these
directly into your repository's Issues tab.
...
Created for developer workshops focusing on AI-assisted coding with tools
like Coder, Cursor, and GitHub Copilot.
