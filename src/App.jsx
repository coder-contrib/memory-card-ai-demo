...
import redDiamond from './assets/red-diamond.svg';
      ...
      {gameStarted ? (
        <div style={{
          ...
          {cards.map((card, index) => (
            ...
            >
              {isCardVisible(index, card.symbol) ? card.symbol : <img src={redDiamond} alt="Card back" style={{ width: '50px', height: '50px' }} />}
            </div>
          ))}
        </div>
      ) : (
