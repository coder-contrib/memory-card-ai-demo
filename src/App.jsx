...
const MemoryGame = () => {
  ...
  // Handle returning to start screen after timeout
    ...
    <div style={{
      ...
      {gameStarted && (
        <div style={{
          ...
          <div style={{
            padding: '10px 20px',
            background: timeLeft <= 10 ? 'rgba(220, 38, 38, 0.8)' : 'rgba(255, 255, 255, 0.2)',
            borderRadius: '10px',
            fontSize: '28px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              You found {matchedPairs.length}/{cardSymbols.length} pairs
            </p>
            <button
