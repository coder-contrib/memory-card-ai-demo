      ...
      {gameStarted ? (
        <div style={{
          ...
          {cards.map((card, index) => (
            ...
            >
              {isCardVisible(index, card.symbol) ? card.symbol : <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><span style={{ color: 'red', fontSize: '32px' }}>♦️</span><span>?</span></div>}
            </div>
          ))}
        </div>
      ) : (
