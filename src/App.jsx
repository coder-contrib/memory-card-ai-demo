      ...
      {gameStarted ? (
        <div style={{
          ...
          {cards.map((card, index) => (
            <div
              ...
              style={{
                width: difficulty === '4x4' ? '100px' : difficulty === '6x6' ? '80px' : '70px',
                height: difficulty === '4x4' ? '100px' : difficulty === '6x6' ? '80px' : '70px',
                ...
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: difficulty === '4x4' ? '48px' : difficulty === '6x6' ? '36px' : '32px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            {Object.keys(cardSymbols).map((size) => (
              <button
                key={size}
