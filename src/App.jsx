    ...
    <div style={{
      ...
      {gameStarted && (
        <div style={{
          ...
          <div style={{
            background: timeLeft <= 10 ? 'rgba(255, 0, 0, 0.2)' : 'rgba(255, 255, 255, 0.2)',
            padding: '5px 15px',
            borderRadius: '25px',
            border: timeLeft <= 10 ? '2px solid rgba(255, 0, 0, 0.5)' : '2px solid rgba(255, 255, 255, 0.5)',
            color: timeLeft <= 10 ? '#ff3333' : 'white'
          }}>
            Time: {timeLeft}s
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Completed in {moves} moves with {timeLeft} seconds left!
            </p>
            <button
              onClick={initializeGame}
              style={{
