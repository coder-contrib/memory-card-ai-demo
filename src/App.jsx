            ...
            <div
              ...
              style={{
                ...
                boxShadow: isCardVisible(index, card.symbol)
                  ...
                  : '0 4px 8px rgba(0,0,0,0.2), inset 0 0 50px rgba(255,255,255,0.1), 0 0 15px rgba(255,215,0,0.3)',
                borderRadius: '15px',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: '48px',
                color: isCardVisible(index, card.symbol) ? 'inherit' : 'gold',
                textShadow: isCardVisible(index, card.symbol) ? 'none' : '0 0 10px rgba(255,215,0,0.7)',
