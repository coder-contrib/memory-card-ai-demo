...
const MemoryGame = () => {
  ...
  const cardSymbols = themeSymbol[theme];
  // Initialize game
  const initializeGame = (newTheme = theme) => {
    const cardSymbols = themeSymbol[newTheme];
          ...
          {cards.map((card, index) => (
            <div
              ...
              style={{
                ...
                justifyContent: "center",
                fontSize: "48px",
                cursor: matchedPairs.includes(card.symbol)
                  ? "default"
                  : "pointer",
                transform: isCardVisible(index, card.symbol)
                  ? "scale(1)"
                  : "scale(1)",
