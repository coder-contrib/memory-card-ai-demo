...
import redDiamondSvg from './assets/red-diamond.svg';
      ...
      {gameStarted ? (
        <div style={{
          ...
          {cards.map((card, index) => (
            ...
            >
              {isCardVisible(index, card.symbol) ? card.symbol : <img src={redDiamondSvg} alt="Card back" style={{ width: '60%', height: '60%' }} />}
            </div>
          ))}
        </div>
      ) : (
