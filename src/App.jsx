...
const MemoryGame = () => {
  ...
  const handleCardClick = (index) => {
    if (!gameStarted || gameWon || gameLost || timerPaused) return;
    ...
    <div style={{
      ...
      {gameStarted && (
        <div style={{
          ...
          <Timer initialTime={60} onTimeout={handleTimeout} isPaused={timerPaused} />
        </div>
      )}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              You found {matchedPairs.length} pairs in {moves} moves.
            </p>
            <button
              ...
              style={{
                padding: '15px 40px',
                fontSize: '20px',
                background: 'linear-gradient(135deg, #ff4444 0%, #ff9999 100%)',
                border: 'none',
                borderRadius: '50px',
                cursor: 'pointer',
                fontWeight: 'bold',
